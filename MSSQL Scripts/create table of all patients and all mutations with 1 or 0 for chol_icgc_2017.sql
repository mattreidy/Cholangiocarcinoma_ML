...
SET @SQL = N'SELECT data_clinical_patient.patient_id + data_clinical_sample.sample_id as id
		...
		,data_clinical_sample.cancer_type_detailed as cancer_type
		,data_clinical_patient.sex
		,data_clinical_patient.age_at_surgery as age'
         + @Columns
		 ...
		 GROUP BY data_clinical_sample.patient_id, data_clinical_sample.sample_id, data_clinical_sample.cancer_type_detailed, data_clinical_patient.patient_id, data_clinical_patient.sex, data_clinical_patient.age_at_surgery' 
