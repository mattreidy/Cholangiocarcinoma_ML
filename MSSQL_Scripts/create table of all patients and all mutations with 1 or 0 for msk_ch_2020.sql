...
SET @SQL = N'SELECT data_clinical_patient.patient_id + data_clinical_sample.sample_id as id
		...
		,FLOOR(data_clinical_patient.AGE) as age'
		 ...
		 GROUP BY data_clinical_sample.patient_id, data_clinical_sample.sample_id, data_clinical_sample.CANCER_TYPE_DETAILED, data_clinical_patient.patient_id, data_clinical_patient.sex, data_clinical_patient.AGE' 
